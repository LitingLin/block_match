...
BOOST_AUTO_TEST_CASE(test_case_3)
{
	...
	BOOST_TEST(blockMatchInitialize<float>(&instance, SearchType::global, LibMatchMeasureMethod::mse, PadMethod::zero, PadMethod::zero, BorderType::normal, SearchFrom::topLeft, true,
