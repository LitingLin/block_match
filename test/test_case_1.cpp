...
BOOST_AUTO_TEST_CASE(test_case_1)
{
	...
	BOOST_TEST(blockMatchInitialize<float>(&instance, SearchType::local, LibMatchMeasureMethod::mse, PadMethod::zero,PadMethod::zero, BorderType::includeLastBlock, SearchFrom::topLeft, true,
