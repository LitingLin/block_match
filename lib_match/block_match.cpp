...
template <typename Type>
void BlockMatch<Type>::get_matrixA_padded_dimensions(int* m, int* n, int *c)
{
	BlockMatchContext<Type> *instance = static_cast<BlockMatchContext<Type>*>(m_instance);

	*m = instance->matrixA_padded_M;
	*n = instance->matrixA_padded_N;
	*c = instance->numberOfChannels;
}

template <typename Type>
void BlockMatch<Type>::get_matrixB_padded_dimensions(int* m, int* n, int *c)
{
	BlockMatchContext<Type> *instance = static_cast<BlockMatchContext<Type>*>(m_instance);
...
template
LIB_MATCH_EXPORT
void BlockMatch<float>::get_matrixA_padded_dimensions(int *, int *, int *);
template
LIB_MATCH_EXPORT
void BlockMatch<double>::get_matrixA_padded_dimensions(int *, int *, int *);
template
LIB_MATCH_EXPORT
void BlockMatch<float>::get_matrixB_padded_dimensions(int *, int *, int *);
template
LIB_MATCH_EXPORT
void BlockMatch<double>::get_matrixB_padded_dimensions(int *, int *, int *);